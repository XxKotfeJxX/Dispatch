...
export default function Sources({startOpen=false}:{startOpen?:boolean}){
  ...
  const [form,setForm]=useState({name:'',slug:'',provider:'generic',recipient_id:'',secret:'',id_path:'',event_type_path:'',subject_path:'',body_path:''})
