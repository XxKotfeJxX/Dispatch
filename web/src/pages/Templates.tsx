...
const variables: Record<string, {key: string; label: string}[]> = {
  common: [
    ...
    {key: 'connection_name', label: 'Integration name'},
    {key: 'account_label', label: 'Connected account'},
  ...
  google: [
    ...
    {key: 'attachment_names', label: 'Attachment names'},
    {key: 'actor', label: 'Drive actor'},
    {key: 'event_title', label: 'Calendar event'},
    {key: 'organizer', label: 'Calendar organizer'},
    {key: 'start', label: 'Start time'},
    {key: 'meet_url', label: 'Google Meet link'},
    {key: 'task_title', label: 'Task'},
    {key: 'list_name', label: 'Task list'},
    {key: 'due', label: 'Due date'},
    {key: 'space_name', label: 'Chat space'},
  ],
  discord: [
    {key: 'author_username', label: 'Username'},
    {key: 'channel_name', label: 'Channel'},
    {key: 'guild_name', label: 'Server'},
    {key: 'timestamp', label: 'Sent at'},
  ],
  telegram: [
    {key: 'sender_username', label: 'Sender username'},
    {key: 'sender_first_name', label: 'Sender first name'},
    {key: 'sender_last_name', label: 'Sender last name'},
    {key: 'chat_title', label: 'Chat'},
    {key: 'chat_username', label: 'Chat username'},
...
const sampleValues: Record<string, Record<string, string>> = {
  ...
  google: {
    ...
    attachment_names: 'report.xlsx', actor: 'Alex', event_title: 'Quarterly review',
    organizer: 'Alex <alex@example.com>', start: '2026-07-27T10:00:00Z',
    meet_url: 'https://meet.google.com/example', task_title: 'Review report',
    list_name: 'Work', due: '2026-07-27', space_name: 'Finance',
  ...
  telegram: {
    ...
    sender: 'Alex Doe', sender_username: 'alex', sender_first_name: 'Alex',
    sender_last_name: 'Doe', event_type: 'telegram.message', service: 'telegram',
    chat_title: 'Alex Doe', chat_username: 'alex', chat_type: 'private',
    message_id: '42', timestamp: '2026-07-26T17:00:00Z', forwarded: 'false',
    has_media: 'false', media_type: '', summary: 'Deployment is ready', priority: 'normal', url: '',
  },
  youtube: {
