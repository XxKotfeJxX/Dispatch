...
Open **Integrations** in the console for large service cards for Telegram account authorization, Discord, GitHub, unified Google services, and YouTube. Demo testing and Universal Webhook configuration are kept in separate test and developer areas. End users never enter provider tokens or application secrets. See [Managed connectors](docs/connectors.md) and [Universal ingress](docs/ingress.md).
