...
Provider constraints are taken from their official documentation: [Discord OAuth and bot installation](https://docs.discord.com/developers/topics/oauth2), [GitHub Apps](https://docs.github.com/en/apps/creating-github-apps), [Gmail push notifications](https://developers.google.com/workspace/gmail/api/guides/push), and [YouTube push notifications](https://developers.google.com/youtube/v3/guides/push_notifications).

Telegram Bot, Viber, ChatGPT, and OpenAI API are not shown as consumer integrations. They do not provide the requested low-friction access to a user's personal notification stream. The outbound Telegram delivery channel remains available and is separate from inbound account integrations.
